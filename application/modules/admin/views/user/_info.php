...
<tr>
                <td style="width: 25%"><strong><?= Yii::t('app', 'Telefono') ?>:</strong></td>
                <td><?= Html::encode($user->profile->Telefono) ?></td>
            </tr>
  ...
  <tr>
                <td><strong><?= Yii::t('app', 'Indirizzo') ?>:</strong></td>
                <td><?= Html::encode($user->profile->Indirizzo) ?></td>
            </tr>

                        ...
                        <div class="name-location justify-content-end">
                            <div class="first-line ">
                                ...
                                <span class="age"><?= $profile->getAge() ?></span>
                                 ...
                                 <span class="px-1">&middot;</span>
                                <h3 class="Telefono"><?= $profile->Telefono ?></h3>
...
<form method="post" action="https://api.whatsapp.com/send/?phone=<?= $profile->Telefono ?>&text&type=phone_number&app_absent=0">
    <button type="submit" class="btn btn-green mb-2 mb-sm-0">
        <?= Icon::fa('whatsapp', ['class' => 'mr-2']) ?>
        <?= Yii::t('youdate', 'whatsapp') ?>
    </button>
</form>
 ...
 <div class="profile-info-block">
                    <div class="text-bold mb-2"><?= Yii::t('youdate', 'Indirizzo') ?>:</div>
                    <div class="text-muted">
                        <?php if ($profile->Indirizzo): ?>
                            <?= Html::prettyPrinted($profile->Indirizzo) ?>
                        <?php else: ?>
                            <?= Yii::t('youdate', '{0} doesn\'t have profile Indirizzo yet', [
                                Html::encode($profile->getDisplayName()),
                            ]) ?>
                        <?php endif; ?>
                    </div>

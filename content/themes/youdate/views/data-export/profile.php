...
<div class="card">
 ...
 <div class="row info-row">
            <div class="col-6 heading"><?= Yii::t('app', 'Telefono') ?>:</div>
            <div class="col-6 value"><?= Html::encode($profile->Telefono) ?></div>
        </div>
...
<div class="info-row">
            <div class="heading"><?= Yii::t('app', 'Indirizzo') ?>:</div>
            <div><?= Html::encode($profile->Indirizzo) ?></div>
        </div>
